...
public class ArrayFunctions
{
    ...
    public static int[] Evens(int[] numbers) => throw new NotImplementedException();
    ...
    public static Duck[] OlderThan(Duck[] ducks, int age) => throw new NotImplementedException();
}
